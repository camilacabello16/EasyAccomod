...
@WebServlet(urlPatterns = {"/company-chat"})
public class CompanyChatController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		RequestDispatcher rd = req.getRequestDispatcher("/views/companychat.jsp");
		rd.forward(req, resp);
	}
